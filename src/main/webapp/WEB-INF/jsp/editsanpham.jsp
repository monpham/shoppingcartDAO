...
<div class="page-container">
    ...
    <div class="left-content">
        <div class="row">
            <h3>Sản phẩm </h3>
            <form:form modelAttribute="sanpham" action="LeveupSanpham">
                <table class="table">
                <c:forEach var="e" items="${sanPhams}">
                    ...
                    <tr>
                        <td>ID SẢN PHẨM :</td>
                        <td>
                            <form:input path="masanpham" value='${e.masanpham}'/>

                        </td>
                    </tr>
                    <tr>
                        <td class="tensp">GIÁ TIỀN :</td>
                        <td>
                            <form:input path="giatien" value='${e.giatien}'/>
                        </td>
                    </tr>
                    <tr>
                        <td>MÔ TẢ :</td>
                        <td>
                            <form:input path="mota" value='${e.mota}'/>
                        </td>
                    </tr>
                    <tr>
                        <td>TÊN SẢN PHẨM :</td>
                        <td>
                            <form:input path="tensanpham" value='${e.tensanpham}'/>
                        </td>
                    </tr>
                    <tr>
                        <td>HÌNH SẢN PHẨM :</td>
                        <td>
                            <form:input type="file" path="hinhsanpham" value='${e.hinhsanpham}'/>
                        </td>
                    </tr>
                    <tr>
                        <td>
