             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="/trangchu">Pooled</a></h1>
							</div>
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                <img class="lg-item-img" src="/admin/images/in1.jpg" alt="">
                                            </div>
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="/admin/images/in2.jpg" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="/admin/images/in3.jpg" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="/admin/images/in4.jpg" alt="">
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
...
<div class="copyrights">
	 <p>© 2020 PR32. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>	
									...
									<li><a href="/maps"><i class="fa fa-map-marker" aria-hidden="true"></i>  <span>Maps</span><div class="clearfix"></div></a></li>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Pages</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul id="menu-academico-sub" >
												...
												<li id="menu-academico-avaliacoes" ><a href="/chitiethoadon">Hóa Đơn</a></li>
											</ul>
								  </ul>
								</div>
							  </div>
...
<script src='<c:url value="/admin/js/bootstrap.min.js"/>'></script>
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src='<c:url value="/admin/js/raphael-min.js"/>'></script>
<script src='<c:url value="/admin/js/morris.js"/>'></script>
