...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link rel="stylesheet" href="/resource/Styles/styles1.css" />
        ...
        <nav class="nav d-flex container">
            ...
            <div class="nav-menu d-flex">
                <ul class="nav-list d-flex">
                    <li class="nav-item">
                        <a href="/trangchu" class="nav-link">Home</a>
                    </li>
...
<section class="section about" id="about">
    <div class="about-center container">
        ...
        <div class="right" data-aos="fade-left" data-aos-duration="2000">
            <img src="/resource/images/mon.jpg" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="portfolio-center container">
        ...
        <div class="portfolio-container">
            <div class="single" data-aos="fade-down" data-aos-duration="2000">
                <img src="/resource/images/work1.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
            ...
            <div class="single" data-aos="fade-right" data-aos-duration="2000">
                <img src="/resource/images/work2.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
            ...
            <div class="single" data-aos="fade-left" data-aos-duration="2000">
                <img src="/resource/images/work3.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
                        <h3>Psd design</h3>
                        <div class="btn-group">
            ...
            <div class="single" data-aos="flip-up" data-aos-duration="2000">
                <img src="/resource/images/work4.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
            ...
            <div class="single" data-aos="flip-right" data-aos-duration="2000">
                <img src="/resource/images/work5.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
            ...
            <div class="single" data-aos="flip-up" data-aos-duration="2000">
                <img src="/resource/images/work6.jpg" alt="" />
                <div class="overlay">
                    <div class="details">
                ...
                <ul class="glide__slides">
                        ...
                        <div class="testimonial">
                            ...
                            <div class="bottom">
                                <div class="img-holder">
                                    <img src="/resource/images/test1.jpg" alt="" />
                                </div>
                                <div>
                                    <h4>Samia Shahrin</h4>
                                    <span>Designer</span>
                    ...
                    <li class="glide__slide">
                        <div class="testimonial">
                            ...
                            <div class="bottom">
                                <div class="img-holder">
                                    <img src="/resource/images/test2.jpg" alt="" />
                                </div>
                                <div>
                                    <h4>Samia Shahrin</h4>
                    ...
                    <li class="glide__slide">
                        <div class="testimonial">
                            ...
                            <div class="bottom">
                                <div class="img-holder">
                                    <img src="/resource/images/test3.jpg" alt="" />
                                </div>
                                <div>
                                    <h4>Samia Shahrin</h4>
            ...
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li class="glide__slide">
                        <div class="single">
                            <div class="img-holder">
                                <img src="/resource/images/quoc.jpg" alt="" />
                            </div>
                            <div class="bottom">
                    ...
                    <li class="glide__slide">
                        <div class="single">
                            <div class="img-holder">
                                <img src="/resource/images/quoc1.jpg" alt="" />
                            </div>
                            <div class="bottom">
                    ...
                    <li class="glide__slide">
                        <div class="single">
                            <div class="img-holder">
                                <img src="/resource/images/quoc3.jpg" alt="" />
                            </div>
                            <div class="bottom">
...
<!-- Footer -->
<footer>
    <p>&copy; Jurado Template. 2020 All right reserved!</p>
</footer>
<!-- AOS -->
