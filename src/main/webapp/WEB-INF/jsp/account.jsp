...
<br>
<a href="addNhanvien"><img src="/admin/images/add4.png" alt="HTML tutorial" style="width:150px;height:70px;"> <Add New Book/> </a>
<table border="1" width="80%">
    ...
    <c:forEach var="nguoiDung" items="${nguoiDung}">
        <tr>
            <td>${nguoiDung.manguoidung}</td>
            <td>${nguoiDung.email}</td>
            <td>${nguoiDung.machucvu}</td>
            <td>${nguoiDung.matkhau}</td>
            <td>
                <a href="deleteNhanvien?manguoidung=${nguoiDung.manguoidung}" ><img src="/admin/images/delete2.png" alt="HTML tutorial" style="width:60px;height:60px;"><Delete</a>
            </td>
            <td>
                <a href="editNhanvien?manguoidung=${nguoiDung.manguoidung}"><img src="/admin/images/edit2.jpg" alt="HTML tutorial" style="width:70px;height:70px;"><Edit</a>
            </td>
        </tr>
    </c:forEach>
</table>
