    ...
    <nav class="navbar navbar-default none_nav">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/tongsanpham"><img src='<c:url value="/resource/Image/icon_yame_shop.png"/>'>PR32-iviettech-2020-Web Developer</a>
            </div>

            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-center">
                    <li class="active"><a href="/addsanpham">Thêm Sản Phẩm</a></li>
                    <li class="dropdown">
                    ...
                    <li><a href="/dashboard">HOME ADMIN </a></li>
                            ...
                            <li id="menu-academico" ><a href="/account"><i class="fa fa-file-text-o"></i>  <span>Account</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a></li>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="/dangnhap" > ${email}
                                <c:if test="${email == null }">ĐĂNG NHẬP</c:if>
                            </a></li>
                        </c:otherwise>
                    </c:choose>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <a href="/chitiet/${sanpham.masanpham}">
                            <div class="sanpham wow zoomIn">
                                ...
                                <a href="deleteSanpham?masanpham=${sanpham.masanpham}">Delete</a>
                                <a href="editSanpham?masanpham=${sanpham.masanpham}">Edit</a>
                            </div>
                        </a>
